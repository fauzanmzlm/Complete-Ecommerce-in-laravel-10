            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Track Booking</a></li>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        @endphp                    
                        <a href="{{route('home')}}">
                            <img style="width: 110px;" src="@foreach($settings as $data) {{$data->logo}} @endforeach" alt="logo">
                        </a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Search Equipments Here....." type="search">
